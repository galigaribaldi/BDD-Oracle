...
create or replace synonym status_auto_f2 for status_auto_f2_hgcg_s2;
...
create or replace synonym auto_f2 for auto_f2_hgcg_s2;
create or replace synonym auto_f3 for auto_f2_igcg_s2@igcg_s2;
...
create or replace synonym auto_particular_f2 for auto_particular_f2_hgcg_s2;
...
create or replace synonym pago_auto_f2 for pago_auto_f2_hgcg_s2;


prompt Creando Sinonimos para cliente
-- cliente
create or replace synonym cliente_f1 for cliente_f1_hgcg_s2;
create or replace synonym cliente_f2 for cliente_f2_igcg_s1@igcg_s1;
create or replace synonym cliente_f3 for cliente_f2_igcg_s2@igcg_s2;