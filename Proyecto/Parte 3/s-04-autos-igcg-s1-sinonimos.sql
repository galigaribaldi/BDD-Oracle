...
--@Descripcion:         Creacion de sinonimos en igcg_s1
...
create or replace synonym sucursal_f3 for sucursal_f3_igcg_s1;
...
create or replace synonym historico_status_auto_f1 for historico_status_auto_f1_igcg_s1;
...
create or replace synonym marca_r3 for marca_r_igcg_s1;
...
create or replace synonym modelo_r3 for modelo_r_igcg_s1;
...
create or replace synonym cliente_f2 for cliente_f2_igcg_s1;
