...
--@Descripcion:         Creacion de sinonimos en hgcg_s1


prompt Creando Sinonimos para Pais
-- Pais -> 2
create or replace synonym pais_f1 for pais_f1_hgcg_s1;
create or replace synonym pais_f2 for pais_f2_hgcg_s2@hgcg_s2;

prompt Creando Sinonimos para sucursal
-- sucursal -> 3
create or replace synonym sucursal_f1 for sucursal_f1_hgcg_s1;
...
-- Status Auto -> 4
--create or replace synonym status_auto_f1 for status_auto_f1_hgcg_s1;
...
-- Auto -> 3
create or replace synonym auto_f1 for auto_f1_hgcg_s1;
...
-- marca
create or replace synonym marca_r1 for marca_r_hgch_s1;
...
-- modelo
create or replace synonym modelo_r1 for modelo_r_hgcg_s1;
...
-- auto carga
create or replace synonym auto_carga_f1 for auto_carga_f1_hgcg_s1;
create or replace synonym auto_carga_f2 for auto_carga_f2_hgcg_s2@hgcg_s2;

prompt Creando Sinonimos para auto particular
-- auto partiuclar
create or replace synonym auto_particular_f1 for auto_particular_f1_hgcg_s1;
...
-- pago auto
create or replace synonym pago_auto_f1 for pago_auto_f1_hgcg_s1;
