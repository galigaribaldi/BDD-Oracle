...
--@Descripcion:         Creacion de TRigger para Pago Ssucriptor en n2
...
BEGIN
    ...
    ----Comprobamos en donde se esta insertando 
        ...
        ---En este caso es Local
            ...
            insert into pago_suscriptor_2(suscriptor_id, num_pago, fecha_pago, importe, recibo_pago)
            values(:new.suscriptor_id, :new.num_pago, :new.fecha_pago, :new.importe, :new.recibo_pago);
        else
    ...
    ----Comprobamos en donde se esta eliminando
        ...
        ---En este caso es remoto
            ...
            raise_application_error(-20001,
            'Error, Valor incorrecto para num_pago');
        end if;          
    ------------------------------------------------------------------------------    
    ------------------------------------------------------------------------------
    WHEN updating THEN
